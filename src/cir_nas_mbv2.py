...
class CirInvertedResidual(nn.Module):
    def __init__(self, inp, oup, stride, expand_ratio,feature_size,fix_block_size):
...
class CirMobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1.0,fix_block_size=-1):
...
def cir_nas_mobilenet(n_class, input_size, width_mult,fix_block_size=-1) -> CirMobileNetV2:
