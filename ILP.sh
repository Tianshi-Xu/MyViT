...
CUDA_VISIBLE_DEVICES=6 python CirILP.py -c configs/datasets/MBV2/imagenet_ILP.yml --model image_nas_mobilenetv2 /opt/dataset/imagenet/
...
CUDA_VISIBLE_DEVICES=4 python CirILP.py -c configs/datasets/ViT/cifar100_ILP.yml --model vit_7_4_32_c100 /home/xts/code/dataset/cifar100/
...
CUDA_VISIBLE_DEVICES=1 python CirILP_b2.py -c configs/datasets/ViT/tiny_ILP.yml --model vit_9_12_64 /home/xts/code/dataset/tiny-imagenet-200
