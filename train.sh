...
# nas
CUDA_VISIBLE_DEVICES=2 python train_nas.py -c configs/datasets/ViT/cifar10_nas.yml --model vit_7_4_32 /home/xts/code/dataset/cifar10/
...
# finetune vit_c10
CUDA_VISIBLE_DEVICES=6 python train_nas.py -c configs/datasets/ViT/cifar10_finetune.yml --model vit_7_4_32 /home/xts/code/dataset/cifar10/

# mbv2 nas
CUDA_VISIBLE_DEVICES=6 python train_nas.py -c configs/datasets/MBV2/cifar10_nas.yml --model c10_nas_mobilenetv2 /home/xts/code/dataset/cifar10/
