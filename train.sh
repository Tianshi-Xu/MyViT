...
# mbv2 fix
CUDA_VISIBLE_DEVICES=4 python train_nas.py -c configs/datasets/MBV2/cifar10_fix.yml --model c10_nas_mobilenetv2 /home/xts/code/dataset/cifar10/
CUDA_VISIBLE_DEVICES=4 python train_nas.py -c configs/datasets/MBV2/cifar100_fix.yml --model c100_nas_mobilenetv2 /home/xts/code/dataset/cifar100/
CUDA_VISIBLE_DEVICES=2 python train_nas.py -c configs/datasets/MBV2/tiny_fix.yml --model tiny_nas_mobilenetv2 /home/xts/code/dataset/tiny-imagenet-200
