...
# mbv2 fix
CUDA_VISIBLE_DEVICES=2 python train_nas.py -c configs/datasets/MBV2/cifar10_fix.yml --model c10_nas_mobilenetv2 /home/xts/code/dataset/cifar10/
...
CUDA_VISIBLE_DEVICES=5 python train_nas.py -c configs/datasets/MBV2/tiny_fix.yml --model tiny_nas_mobilenetv2 /home/xts/code/dataset/tiny-imagenet-200
...
CUDA_VISIBLE_DEVICES=1 python train_nas.py -c configs/datasets/ViT/cifar100_fix.yml --model vit_7_4_32_c100 /home/xts/code/dataset/cifar100/
CUDA_VISIBLE_DEVICES=2 python train_nas.py -c configs/datasets/ViT/tiny_fix.yml --model vit_9_12_64 /home/xts/code/dataset/tiny-imagenet-200/
